...
- Never touch the main LoomClone recording pipeline (`app/LoomClone/`) from this directory. Findings that suggest a main-app change should be recorded as notes in the run directory or in `docs/archive/m2-pro-video-pipeline-failures.md`, not applied directly.
