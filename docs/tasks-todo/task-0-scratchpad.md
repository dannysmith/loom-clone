...
- [ ] Add a cancel button to the recording overlay which abandons the recording after a confirmation. This will also have to send a message to the server to delete the in-progress recording on the server end.
