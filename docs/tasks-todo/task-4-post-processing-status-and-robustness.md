...
> **Implementation status (2026-06-04): Phases 0 + 1 + 2 landed** on branch `task-4-post-processing-robustness`.
...
> **Remaining: Phase 3 (per-artifact regenerate buttons, the two-pipeline HLS-vs-source reprocess distinction with cleaned-up-HLS handling), Phase 4 (final simplification pass).**
